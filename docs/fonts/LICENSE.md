...
All fonts in this folder are licensed under the SIL Open Font License 1.1 and are self-hosted here on purpose: the skill's rule 2 says fonts are never loaded from a third-party CDN, and this page follows its own rule.
